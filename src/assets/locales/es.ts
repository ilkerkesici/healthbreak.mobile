export default {
  ...
  exercise: {
    default_title: 'Ejercicio',
    ready: {
      start: 'Estoy listo, empezar',
    },
    progress: {
      running: 'En curso…',
      paused: 'Pausado',
  ...
  welcome: {
    title_1: 'Tu pausa más saludable',
    title_2: 'en solo 1 minuto.',
    title_3: 'Microejercicios avalados por expertos que puedes hacer en cualquier lugar.',
  ...
  paywall: {
    ...
    new: {
      ...
      package_card: {
        discount_badge: '{{percent}}% DE AHORRO',
        billed_yearly: '{{price}} / facturado anualmente',
        monthly_price: '{{price}}/mes',
        frequency: {
          yearly: 'ANUAL',
          monthly: 'MENSUAL',
          plan: 'PLAN',
